...
const CourseCard = ({ course }) => {
  ...
  return (
    <div className="p-3 lg:p-5">
      ...
      <h2
        className="text-[18px] leading-[30px] lg:text-[26px] lg:leading-9 text-headingColor font-[700] mt-3
            lg:mt-5"
      >
        {name}
      </h2>
      ...
      <div className="mt-2 lg:mt-4 flex items-center justify-between">
        <span
          className="bg-[#eee3fb] text-primaryColor py-1 px-2 lg:py-2 lg:px-6 text-[12px] leading-4
                lg:text-[16px] font-semibold lg:leading-7 rounded "
        >
          {specialization}
        </span>
      ...
      <div className="mt-[18px] lg:mt-5 flex items-center justify-between">
        <div>
          ...
          <p className="text-[14px] leading-7
            font-[400] text-textColor">{courseName}
            </p>
        </div>
        <Link
                  to="/courses"
